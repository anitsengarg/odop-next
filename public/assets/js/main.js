/**
 * ODOP UP Portal - Main JavaScript
...
function getLoginModalMarkup() {
    return [
        ...
        '                <img src="img/logo.png" alt="ODOP Uttar Pradesh" class="login-modal-brand-logo" loading="lazy">',
        '            </div>',
        ...
        '                    <img src="img/logo.png" alt="ODOP Uttar Pradesh" class="login-register-stage-logo" loading="lazy">',
...
function initSupplierRegistrationForm() {
    ...
    const profileTypeContent = {
        ...
        distributor: {
            ...
            summaryLabel: 'Profile Summary Line',
            summaryPlaceholder: 'e.g. Regional Distributor | Agra & Western UP | Established 2012',
