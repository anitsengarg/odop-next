...
export const metadata: Metadata = {
  title: "Chief Minister's Message | About ODOP UP",
  description:
    "Chief Minister's message for ODOP Uttar Pradesh — vision and guidance for strengthening artisans, MSMEs, and district enterprise ecosystems.",
};
    ...
    <main className="main-content schemes-page">
      <section className="page-hero schemes-hero">
        ...
        <div className="container page-hero-content">
          <h1 className="page-hero-title">Chief Minister&apos;s Message</h1>
          <p className="page-hero-subtitle">
            A leadership note on strengthening artisans, MSMEs, and district
            enterprise ecosystems under ODOP in Uttar Pradesh.
          </p>
        </div>
      </section>
