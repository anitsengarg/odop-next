...
export const metadata: Metadata = {
  title: "Minister's Message | About ODOP UP",
  description:
    "Minister's message for ODOP Uttar Pradesh — policy direction and implementation priorities for ODOP-linked industry growth, skills, and market development.",
};
    ...
    <main className="main-content schemes-page">
      <section className="page-hero schemes-hero">
        ...
        <div className="container page-hero-content">
          <h1 className="page-hero-title">Minister&apos;s Message</h1>
          <p className="page-hero-subtitle">
            Policy direction and implementation priorities for ODOP-linked
            industry growth, skills, and market development.
          </p>
        </div>
      </section>
