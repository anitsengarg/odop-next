    ...
    <main className="main-content schemes-page about-static-page">
      <section className="page-hero schemes-hero">
        ...
        <div className="container page-hero-content">
          <h1 className="page-hero-title">Frequently Asked Questions (FAQs)</h1>
          <p className="page-hero-subtitle">Answers to common queries about the ODOP programme in Uttar Pradesh.</p>
        </div>
      </section>
        ...
        <section className="static-content-wrap faq-wrap">
          <article className="static-card">
            ...
            <p>The One District One Product (ODOP) Programme was envisioned and inaugurated on January 24, 2018
              by the Hon'ble Chief Minister of UP Shri Yogi Adityanath on Uttar Pradesh Divas. The project
              aims to encourage visibility and sale of indigenous and specialized products/crafts of Uttar
              Pradesh and generate employment at district level.</p>
            <p>Under the project, one particular product is selected from every district of Uttar Pradesh. These
          ...
          <article className="static-card">
            ...
            <p>Reference: <a className="cfc-link-btn"
              href="https://odopup.in/en/article/marketing-development-assistance-scheme" target="_blank"
              rel="noopener">Marketing Development Assistance Scheme</a></p>
          </article>
          <article className="static-card">
            ...
            <p>Reference: <a className="cfc-link-btn" href="https://odopup.in/en/article/finance-assistance-schemes"
              target="_blank" rel="noopener">Finance Assistance Schemes</a></p>
          </article>
          <article className="static-card">
            ...
            <ul className="static-list">
              ...
              <li><i className="fas fa-user-check"></i><span>Applicant must be a resident of Uttar Pradesh.</span>
              </li>
            ...
            <p>Reference: <a className="cfc-link-btn" href="https://odopup.in/en/article/skill-development-scheme"
              target="_blank" rel="noopener">Skill Development Scheme</a></p>
          </article>
          <article className="static-card">
            ...
            <h4>In-Principal approval of SPV by SLSC (Project less than 10 Cr)</h4>
            ...
            <h4>In-Principal approval of SPV by HPC (Project more than 10 Cr)</h4>
            <div className="policy-table-wrap">
              <table className="policy-table">
                <thead>
                  <tr>
