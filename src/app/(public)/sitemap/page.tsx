...
export const metadata: Metadata = {
  title: "Sitemap | One District One Product – Uttar Pradesh",
  description: "Sitemap for ODOP Uttar Pradesh website.",
};
...
const sitemapSections: Array<{ title: string; links: Array<{ label: string; href: string }> }> = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Grievance Redressal", href: "/resources/grievance-redressal" },
    ],
  },
  {
    ...
    <main className="main-content schemes-page">
      <section className="page-hero about-hero">
        ...
        <div className="container page-hero-content">
          ...
          <p className="page-hero-subtitle">Quick access to major sections and pages of ODOP Uttar Pradesh.</p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
            {sitemapSections.map((section) => (
              <article key={section.title} style={{ border: "1px solid #dfe5f1", borderRadius: "10px", padding: "16px" }}>
