...
export default function FeedbackPage() {
  return (
    <main className="main-content schemes-page">
      ...
      <div className="container"><div className="section-header"><span className="eyebrow">Your Voice Matters</span><h2>Submit Feedback</h2><div className="divider"><span /><span /><span /></div></div><section className="static-content-wrap"><article className="static-card"><p>To share your feedback about the ODOP programme, please visit the official ODOP UP portal at <a href="https://odopup.in" target="_blank" rel="noopener noreferrer">odopup.in</a> or contact us at <strong>odop-up@nic.in</strong> (Toll Free).</p></article></section></div>
    </main>
  );
}
