...
export const metadata: Metadata = {
  title: "Screen Reader Access | One District One Product – Uttar Pradesh",
  description:
    "Accessibility information and screen reader compatibility details for the ODOP Uttar Pradesh website.",
};
      ...
      <section className="section section-surface-white">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              One District One Product, Uttar Pradesh website complies with World Wide Web Consortium (W3C)
